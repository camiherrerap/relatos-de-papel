...
const CarritoCantidadLibro = ({book}) => {
    const {carrito, setCarrito, buyLibros} = useContext(Context);
    ...
    return (
        <div>
            <button className="btn control" onClick={resta}>
            ...
            <button className="btn control" onClick={() => buyLibros(book)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
export default CarritoCantidadLibro;